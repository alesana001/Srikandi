...
import com.simpus.srikandi.activity.adapters.ListBalitaAdapter;
import com.simpus.srikandi.activity.objects.Balita;
...
public class ListBalitaActivity extends AppCompatActivity {

    RecyclerView listbalita;
    ArrayList<Balita> data;
    ListBalitaAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        listbalita = (RecyclerView) findViewById(R.id.listBalitaView);
    ...
    public void getData(){
        ...
        url = "http://gizikia.dinkes.surakarta.go.id/srikandi_php_file/list_balita.php?Kode_Wilayah="+Desa;
            ...
            public void onResponse(JSONArray response) {
                ...
                try {
                    ...
                    for (int i=0; i<response.length();i++){
                        ...
                        String Kode_Wilayah = object.getString("Kode_Wilayah");


                        data.add(new Balita (No_Index_Balita_Dinas,Nama_Bayi,Tanggal_Lahir, Nama_Ibu, Nama_Ayah, Kode_Wilayah));
                        ...
                        LinearLayoutManager layoutManager= new
                                ...
                                false);
                        listbalita.setHasFixedSize(true);
                        listbalita.setLayoutManager(layoutManager);
                        adapter = new
                                ListBalitaAdapter(ListBalitaActivity.this, data);
                        adapter.notifyDataSetChanged();
                        progressDialog.dismiss();
                        listbalita.setAdapter(adapter);
