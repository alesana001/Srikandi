...
public class ListIbuhmlAdapter extends RecyclerView.Adapter<com.simpus.satitiv2.activity.adapters.ListIbuhmlViewHolder> {
    ...
    @Override
    public com.simpus.satitiv2.activity.adapters.ListIbuhmlViewHolder onCreateViewHolder(ViewGroup parent, int viewType){
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_ibuhml, null);
        com.simpus.satitiv2.activity.adapters.ListIbuhmlViewHolder view = new com.simpus.satitiv2.activity.adapters.ListIbuhmlViewHolder(layoutView);
        return view;
    }

    @Override
    public void onBindViewHolder(com.simpus.satitiv2.activity.adapters.ListIbuhmlViewHolder holder, int position){
